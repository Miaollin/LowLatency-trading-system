...
#ifndef LLT_ME_MAX_TICKERS
#define LLT_ME_MAX_TICKERS 8
#endif
  constexpr size_t ME_MAX_TICKERS = LLT_ME_MAX_TICKERS;

  /// Maximum size of lock free queues used to transfer client requests, client responses and market updates between components.
#ifndef LLT_ME_MAX_CLIENT_UPDATES
#define LLT_ME_MAX_CLIENT_UPDATES (256 * 1024)
#endif
#ifndef LLT_ME_MAX_MARKET_UPDATES
#define LLT_ME_MAX_MARKET_UPDATES (256 * 1024)
#endif
  constexpr size_t ME_MAX_CLIENT_UPDATES = LLT_ME_MAX_CLIENT_UPDATES;
  constexpr size_t ME_MAX_MARKET_UPDATES = LLT_ME_MAX_MARKET_UPDATES;

  /// Maximum trading clients.
#ifndef LLT_ME_MAX_NUM_CLIENTS
#define LLT_ME_MAX_NUM_CLIENTS 256
#endif
  constexpr size_t ME_MAX_NUM_CLIENTS = LLT_ME_MAX_NUM_CLIENTS;

  /// Maximum number of orders per trading client.
#ifndef LLT_ME_MAX_ORDER_IDS
#define LLT_ME_MAX_ORDER_IDS (1024 * 1024)
#endif
  constexpr size_t ME_MAX_ORDER_IDS = LLT_ME_MAX_ORDER_IDS;

  /// Maximum price level depth in the order books.
#ifndef LLT_ME_MAX_PRICE_LEVELS
#define LLT_ME_MAX_PRICE_LEVELS 256
#endif
  constexpr size_t ME_MAX_PRICE_LEVELS = LLT_ME_MAX_PRICE_LEVELS;
